...
CREATE TABLE `packages` (
  ...
  `package_region` char(3) COLLATE utf8mb4_general_ci NOT NULL,
  `package_dest_region` char(3) COLLATE utf8mb4_general_ci NOT NULL,
  `package_format` varchar(3) COLLATE utf8mb4_general_ci NOT NULL,
...
ALTER TABLE `packages`
  ...
  ADD CONSTRAINT `packages_ibfk_2` FOREIGN KEY (`package_region`) REFERENCES `courier_regions` (`region_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  ADD CONSTRAINT `packages_ibfk_4` FOREIGN KEY (`package_dest_region`) REFERENCES `courier_regions` (`region_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `packages_ibfk_5` FOREIGN KEY (`package_format`) REFERENCES `package_formats` (`format_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
