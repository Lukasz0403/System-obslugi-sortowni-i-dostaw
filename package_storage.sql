...
--
-- Host: db
-- Generation Time: Apr 08, 2026 at 09:27 AM
...
CREATE TABLE `packages` (
  ...
  `package_region` char(3) NOT NULL,
  `package_dest_region` char(3) NOT NULL,
  `package_format` varchar(3) NOT NULL,
...
CREATE TABLE `recipients` (
  ...
  `recipient_postcode` char(6) NOT NULL,
...
CREATE TABLE `senders` (
  ...
  `sender_postcode` char(6) NOT NULL,
  `sender_email` varchar(20) DEFAULT NULL,
